...
class PSP_Territorial_Importer {
	 ...
	 *
	 * Prefers panama_clean.json (generated by scripts/clean_csv_to_json.py) over
	 * the legacy panama_data.json when both are present.
	 *
	...
	public function import_from_json( $truncate = false ) {
		// Prefer the clean JSON generated by the Python script.
	...
	private function flush_batch( $table, array $placeholders, array $values ) {
		...
		$sql = "INSERT INTO {$table} (id,name,slug,code,type,parent_id,level,is_active) VALUES " // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
